...
namespace :shared do
  ...
  task :mkdir do
    ...
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/grouping/scans"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/grouping/uploads"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/grouping/dematbox_scans"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/grouping/archives"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/input"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/output"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/mapping"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/abbyy/input"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/abbyy/output"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/abbyy/processed"
    command << "mkdir -p #{shared_path}/files/#{rails_env}/prepa_compta/pre_assignments/abbyy/errors"
    run command.join('; ')
  end
