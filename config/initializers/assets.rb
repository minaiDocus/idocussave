...
Rails.application.config.assets.precompile += %w( account/profiles.css account/mcf_settings.css account/addresses.css account/organizations.css account/group_organizations.css account/ibiza.css account/paper_processes.css
...
Rails.application.config.assets.precompile += %w( inner.js welcome.js account/ftps.js account/reporting.js account/profile.js account/addresses.js account/organizations.js account/group_organizations.js account/software_users.js
                                                  ...
                                                  account/pre_assignment_blocked_duplicates.js ckeditor/* )
