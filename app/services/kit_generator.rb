...
class KitGenerator
  ...
  TRIMESTRE = [nil, '1er Trimestre', '2e Trimestre', '3e Trimestre', '4e Trimestre'].freeze

  def self.folder(folders, file_sending_kit)
  ...
  def self.mail(mails, file_sending_kit)
  ...
  def self.customer_labels(labels)
  ...
  def self.folder_bloc(pdf, folder, file_sending_kit)
    pdf.font_size 16
  ...
  def self.mail_bloc(pdf, mail, file_sending_kit)
    pdf.font_size 8
  ...
  def self.customer_label_bloc(pdf, label, y = 0)
      ...
      pdf.bounding_box [15, pdf.cursor], width: 297 do
        label.each_with_index do |field, index|
          if index == 1
            ...
            height = height * 10 # temp dirty fix for imagemagick compatibility
  ...
  def self.label_bloc(pdf, label, y = 0)
    pdf.bounding_box [y, pdf.cursor], width: 297, height: 111 do
      pdf.move_down 18
