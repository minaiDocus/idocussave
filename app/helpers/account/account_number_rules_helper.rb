module Account::AccountNumberRulesHelper
  def rule_target_options_for_select
    [
      ...
      [t('activerecord.models.account_number_rule.attributes.rule_type_values.debit'), 'debit'],
      [t('activerecord.models.account_number_rule.attributes.rule_type_values.credit'), 'credit']
    ]
  end
