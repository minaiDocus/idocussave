class Api::Mobile::PreseizuresController < MobileApiController
  ...
  def get_details
    ...
    render json: { pre_tax_amount: pre_tax_amount, preseizure: preseizure, preseizure_entries: preseizure_entries, preseizure_accounts: preseizure.accounts, analytics: data_analytics }, status:200
  end
