...
class Account::IbizaController < Account::OrganizationController
  ...
  def ibiza_params
    params.require(:ibiza).permit(:access_token, :access_token_2, :is_auto_deliver, :is_analysis_activated, :is_analysis_to_validate, :description_separator, :piece_name_format_sep).tap do |whitelist|
