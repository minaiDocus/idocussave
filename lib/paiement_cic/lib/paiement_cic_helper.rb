...
module PaiementCicHelper
  def paiement_cic_hidden_fields(price, reference, options = {})
    ...
    html = '
        ...
        <input type="hidden" name="url_retour"        id="url_retour"       value="' + callback_account_cmcic_url + '?order_id=' + reference + '" />
        <input type="hidden" name="url_retour_ok"   id="url_retour_ok"  value="' + success_account_cmcic_url + '?order_id=' + reference + '" />
        <input type="hidden" name="url_retour_err"   id="url_retour_err" value="' + cancel_account_cmcic_url + '?order_id=' + reference + '" />
