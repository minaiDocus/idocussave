...
ActiveRecord::Schema.define(version: 20191028091032) do
  ...
  create_table "softwares_settings", force: :cascade do |t|
    ...
    t.boolean "is_fec_agiris_used",                           default: false
    t.integer "is_fec_agiris_auto_deliver",         limit: 4, default: -1,    null: false
  end
  ...
  add_index "softwares_settings", ["is_fec_agiris_used"], name: "index_softwares_settings_on_is_fec_agiris_used", using: :btree
