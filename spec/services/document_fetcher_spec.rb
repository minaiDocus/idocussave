...
describe DocumentFetcher do
  ...
  it '.clean_file_name returns TS0001_TS_2013_001.pdf' do
    ...
    expect(DocumentFetcher.clean_file_name(dirty_file_name)).to eq('TS0001_TS_2013_001.pdf')
  end
  ...
  it ".valid_file_names returns ['TS0001_TS_201301_001.PDF', 'TS0001 TS 201301 002.pdf', 'TS0002 TS 2013 001.pdf']" do
    ...
    expect(DocumentFetcher.valid_file_names(file_names)).to eq(['TS0001_TS_201301_001.PDF', 'TS0001 TS 201301 002.pdf', 'TS0002 TS 2013 001.pdf'])
  end
end
