...
describe UpdatePeriodDataService do
  ...
  it 'set values' do
    ...
    report.save
    preseizure = Pack::Report::Preseizure.create(name: document.name, piece_id: Moped::BSON::ObjectId.new)
    report.preseizures << preseizure
    preseizure2 = Pack::Report::Preseizure.create(name: document.name, piece_id: Moped::BSON::ObjectId.new)
