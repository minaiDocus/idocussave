...
describe PreAssignmentService do
  describe '.pending' do
    before(:all) do
      ...
      @piece1 = Pack::Piece.create(name: 'TS0001 AC 201401 001',
                                   pack_id: @pack.id,
                                   origin: 'scan',
                                   is_awaiting_pre_assignment: true)
      @piece2 = Pack::Piece.create(name: 'TS0001 AC 201401 002',
                                   pack_id: @pack.id,
                                   origin: 'scan',
                                   is_awaiting_pre_assignment: true)
      ...
      @piece3 = Pack::Piece.create(name: 'TS0001 AC 201402 001',
                                   pack_id: @pack2.id,
                                   origin: 'scan',
                                   is_awaiting_pre_assignment: true)
    ...
    it 'return 2 entries' do
      ...
      pre_assignment.pack_name.should eq('TS0001 AC 201401')
      ...
      pre_assignment.pack_name.should eq('TS0001 AC 201402')
