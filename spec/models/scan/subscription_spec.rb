...
describe Scan::Subscription do
  ...
  it "check default entry" do
    ...
    @scan_subscription.quantity_of_a_lot_of_dematbox_scan.should eq(1)
    ...
    @scan_subscription.price_of_a_lot_of_upload.should eq(6)
    @scan_subscription.price_of_a_lot_of_dematbox_scan.should eq(6)
